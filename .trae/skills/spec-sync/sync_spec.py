...
class SpecSynchronizer:
    ...
    def __init__(self, repo_root: Path):
        ...
        self.skills_dir = repo_root / ".trae" / "skills" / "spec-sync"
    ...
    def auto_detect_chapters(self, content: str) -> List[Chapter]:
        ...
        if not chapter_starts:
            raise ValueError(
                "No chapters found in DEV_SPEC.md. Expected format: '## N. Title'"
            )
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Sync DEV_SPEC.md with Skills directory"
    )
    parser.add_argument(
    ...
    # Detect repo root (assuming script is in .trae/skills/implement-from-spec/)
