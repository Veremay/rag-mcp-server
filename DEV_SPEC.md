...
|---------|---------|------|---------|------|
| A1 | 初始化目录树与最小可运行入口 | [x] | 2026-02-03 | |
| A2 | 引入 pytest 并建立测试目录约定 | [x] | 2026-02-03 | |
| A3 | 配置加载与校验（Settings） | [x] | 2026-02-03 | |
...
| B7.4 | Local Embedding 实现 | [x] | 2026-02-04 | |
...
| C3 | Loader 抽象基类与 PDF Loader | [x] | 2026-02-04 | |
| C4 | Splitter 集成（调用 Libs） | [x] | 2026-02-04 | |
...
| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| H1 | RagasEvaluator 实现 | [x] | 2026-02-11 | 原 F5 |
| H2 | CompositeEvaluator 实现 | [x] | 2026-02-11 | |
| H3 | EvalRunner + Golden Test Set | [x] | 2026-02-11 | 原 F4 |
| H4 | 评估面板页面 | [x] | 2026-02-11 | |
| H5 | Recall 回归测试 (E2E) | [x] | 2026-02-11 | |
...
| I3 | 完善 README | [x] | 2026-02-13 | 原 G3 |
| I4 | 接口一致性契约测试 | [x] | 2026-02-13 | 原 G4 |
| I5 | 全链路 E2E 验收 | [x] | 2026-02-13 | 包含 ingest/query/dashboard |
